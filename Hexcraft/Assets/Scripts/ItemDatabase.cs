...
public class ItemDatabase : MonoBehaviour{
    ...
    void Start (){
        ...
        items.Add(new Item("EarthBlock", 1,"A pile of mud",0, 0,0 ,Item.ItemType.Block, EarthBlock));
        items.Add(new Item("CoalBlock", 2, "A rocky description", 0, 0,0, Item.ItemType.Block, CoalBlock));
        items.Add(new Item("DiamondBlock", 3, "A rocky description",0 , 0,0, Item.ItemType.Block, DiamondBlock));
        items.Add(new Item("RedstoneBlock", 4, "A rocky description", 0, 0,0, Item.ItemType.Block, RedstoneBlock));
        items.Add(new Item("StoneBlock", 5, "A rocky description", 0, 0,0, Item.ItemType.Block, StoneBlock));
        ...
        items.Add(new Item("IronBlock", 21,"Good in a sticky situation",0, 0,0, Item.ItemType.Block, IronBlock));
        ...
        items.Add(new Item("RedstoneDust", 24, "Good in a sticky situation", 0, 0,0, Item.ItemType.Block, RedstoneDust));
        items.Add(new Item("GrassBlock", 25, "Good in a sticky situation", 0, 0,0, Item.ItemType.Block, GrassBlock));
